...
#include "account.h"
#include "keyboard.h"
#include "acknowledgechallenge.h"
#include "pinchallenge.h"
...
struct IFireboltAccessor {
    ...
    */
    ...
    virtual Wifi::IWifi& WifiInterface() const = 0;

    virtual ClosedCaptions::IClosedCaptions& ClosedCaptionsInterface() const = 0;

    virtual AudioDescriptions::IAudioDescriptions& AudioDescriptionsInterface() const = 0;

    virtual VoiceGuidance::IVoiceGuidance& VoiceGuidanceInterface() const = 0;

    virtual Device::IDevice& DeviceInterface() const = 0;

    virtual UserGrants::IUserGrants& UserGrantsInterface() const = 0;

    virtual Privacy::IPrivacy& PrivacyInterface() const = 0;
    ...
    virtual AcknowledgeChallenge::IAcknowledgeChallenge& AcknowledgeChallengeInterface() const = 0;

    virtual PinChallenge::IPinChallenge& PinChallengeInterface() const = 0;
    ...
    virtual HDMIInput::IHDMIInput& HDMIInputInterface() const = 0;

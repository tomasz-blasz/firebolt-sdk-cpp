...
namespace WPEFramework {
    ...
    /* FontFamily  */
    ENUM_CONVERSION_BEGIN(Firebolt::Accessibility::FontFamily)
        { Firebolt::Accessibility::FontFamily::MONOSPACED_SERIF, _T("monospaced_serif") },
    ...
    /* FontEdge  */
    ENUM_CONVERSION_BEGIN(Firebolt::Accessibility::FontEdge)
        { Firebolt::Accessibility::FontEdge::NONE, _T("none") },

...
namespace Firebolt {
    ...
    public:
        ...
        Content::IContent& ContentInterface() const override
        {
            auto module = _moduleMap.find("Content");
            Content::ContentImpl* content = nullptr;

            if (module != _moduleMap.end()) {
                content = dynamic_cast<Content::ContentImpl*>(module->second);
            } else {
                content = new Content::ContentImpl();
                _moduleMap.emplace("Content", content);
            }
            return *content;
        }

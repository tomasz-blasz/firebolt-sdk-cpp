...
namespace SecureStorage {
    ...
    public:
         ...
         */
        void clearForApp( const std::string& appId, const StorageScope& scope, Firebolt::Error *err = nullptr ) override;

        /*
         removeForApp
         Removes single data value for a specific app.
         */
        void removeForApp( const std::string& appId, const StorageScope& scope, const std::string& key, Firebolt::Error *err = nullptr ) override;

        /*
         setForApp
         Set or update a secure data value for a specific app.
         */
        void setForApp( const std::string& appId, const StorageScope& scope, const std::string& key, const std::string& value, const std::optional<StorageOptions>& options, Firebolt::Error *err = nullptr ) override;
